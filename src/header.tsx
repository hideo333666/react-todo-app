      ...
      <header className={HEADER_CLASS}>
        ...
        <ul className="header__nav-links">
          <li className="header__nav-links__item">
            <a href="/" className="header__nav-links__item__link">Home</a>
          </li>
          <li className="header__nav-links__item">
            <a href="/about" className="header__nav-links__item__link">About</a>
          </li>
          <li className="header__nav-links__item">
            <a href="/contact" className="header__nav-links__item__link">Contact</a>
          </li>
        </ul>
      </header>
    </>
